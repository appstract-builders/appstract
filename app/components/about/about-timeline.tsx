    ...
    <section className="w-full max-w-6xl px-4 py-16 sm:px-0">
      <div className="grid gap-8 lg:grid-cols-[0.92fr_1.08fr] lg:gap-10">
        <div className="lg:sticky lg:top-32 lg:h-fit">
          <div className="overflow-hidden rounded-[2.4rem] border border-white/10 bg-[linear-gradient(180deg,rgba(9,12,25,0.96),rgba(5,8,18,0.98))] px-5 py-6 shadow-[0_24px_90px_rgba(2,8,23,0.24)] sm:px-7 sm:py-8">
            ...
            <div className="mt-8 grid grid-cols-2 gap-3">
              <div className="rounded-[1.4rem] border border-[#FF8904]/16 bg-[#FF8904]/6 px-4 py-4">
        ...
        <div className="relative pl-12 sm:pl-16">
          <div className="absolute left-4 top-0 h-full w-px bg-gradient-to-b from-[#FF8904]/75 via-cyan-300/30 to-transparent sm:left-6" />
          ...
          <div className="grid gap-5">
            {milestones.map((milestone, index) => (
              ...
              >
                ...
                <div className="absolute left-[-2.35rem] top-7 flex h-8 w-8 items-center justify-center rounded-full border border-[#FF8904]/24 bg-[#0b1120] text-[0.6rem] uppercase tracking-[0.16em] text-[#d7caff] shadow-[0_10px_30px_rgba(128,82,221,0.18)] sm:left-[-2.8rem] sm:h-10 sm:w-10">
                  {milestone.year}
                </div>

                <div className="relative z-10 flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                  <div className="max-w-2xl">
                    <p className="text-[0.62rem] uppercase tracking-[0.34em] text-[#FF8904]/68">
                      {milestone.label}
                    </p>
                  ...
                  <div className="grid min-w-[10rem] gap-3 sm:justify-items-end">
                    ...
                    <div className="w-full max-w-[10rem] rounded-[1.25rem] border border-white/8 bg-white/[0.03] p-3">
                      ...
                      <div className="mt-3 h-8 rounded-[0.8rem] bg-[#FF8904]/18" />
